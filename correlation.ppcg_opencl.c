  ...
  if (ret != CL_SUCCESS) {\
   ...
   __ppcg_scopinst = prl_scop_enter(&__ppcg_scop);
...

    {
      ...
      if (size_data < sizeof(double)) size_data = sizeof(double);
    ...
    }
    {
      ...
      if (size_mean < sizeof(double)) size_mean = sizeof(double);
    ...
    }
    {
      ...
      if (size_stddev < sizeof(double)) size_stddev = sizeof(double);
    ...
    }
    {
      ...
      if (size_symmat < sizeof(double)) size_symmat = sizeof(double);
